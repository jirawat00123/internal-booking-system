...
async function main() {
  ...
  const employeesData = [
    ...
    { code: 'SEC001', name: 'สมหมาย รปภ (Guard)', posName: 'จป.เทคนิค', role: 'GUARD' },
  ...
  for (const emp of employeesData) {
    ...
    if (positionFound) {
      // 3.1 สร้างตัวพนักงาน (ใช้ upsert เพื่อป้องกันโค้ดซ้ำและปลอดภัยขึ้น)
      ...
      // 3.2 สร้างบัญชีผู้ใช้งาน (User) ผูกกับพนักงาน
