...
async function seedDatabase() {
  ...
  try {
    ...
    const deptNames = [
      ...
      'แผนกวิศวกรรมซ่อมบำรุง', 'แผนกวิศวกรรมสารสนเทศและเทคโนโลยี',
    ...
    const employeesData = [
      ...
      { code: 'MC-WK0006', name: 'นายจิระพงค์ ธิบดี (นีโน่)', posName: 'หัวหน้าช่างประกอบและติดตั้ง', role: 'USER' },
      { code: 'MC-WK0010', name: 'นายสายฝน มณีชัย (หนู)', posName: 'หัวหน้าช่างเชื่อมประกอบ', role: 'USER' },
      { code: 'MC-WK0012', name: 'นายศรศิริ บุญแก้ว (โก้)', posName: 'หัวหน้าช่างเชื่อมประกอบ', role: 'USER' },
      { code: 'MC-WK0334', name: 'นายสุริยันต์ พรมสะอาด (ยันต์)', posName: 'หัวหน้าช่างเชื่อมประกอบ', role: 'USER' },
      { code: 'MC-WK0358', name: 'นายบุญชู กรสันเทียะ (เล็ก)', posName: 'หัวหน้าช่างเชื่อมประกอบ', role: 'USER' },

      { code: 'MC-WK0618', name: 'นายกฤษฎา คชเสนีย์ (ไนกี้)', posName: 'วิศวกรผลิต', role: 'USER' },
      { code: 'MC-WK0609', name: 'นางสาวอาทิตยา ราชบัณฑิต (ฟ้า)', posName: 'วิศวกรควบคุมคุณภาพ', role: 'USER' },
      { code: 'MC-WK0633', name: 'นายพีรดนย์ ทองคำ (เซน)', posName: 'วิศวกรผลิต', role: 'USER' },

      { code: 'MC-EN0477', name: 'นายวราวุธ ซาผู (หนุ่ม)', posName: 'จป.วิชาชีพ', role: 'USER' },
      { code: 'MC-EN0568', name: 'นายนิติกร หลวงยศ (กร)', posName: 'จป.เทคนิค', role: 'USER' },
      { code: 'MC-WK0620', name: 'นางสาวกัญญารัตน์ เทียมแก้ว (จุ๊บแจง)', posName: 'จป.วิชาชีพ', role: 'USER' },
      
      { code: 'MC-WK0029', name: 'นายชวลิต ยองแสงจันทร์ (หลอ)', posName: 'หัวหน้าช่างงานระบบไฟฟ้า', role: 'USER' },
      { code: 'MC-WK0514', name: 'นางสาวปิยวดี จั้นพลแสน (แนน)', posName: 'ช่างระบบงานไฟฟ้า', role: 'USER' },
      { code: 'MC-WK0565', name: 'นายอนุพงศ์ พิมพา (ตั้น)', posName: 'ช่างระบบงานไฟฟ้า', role: 'USER' },
      { code: 'MC-WK0581', name: 'นายเสถียรชัย เชื้อไชยนา (แชมป์)', posName: 'ช่างระบบงานไฟฟ้า', role: 'USER' },
      { code: 'MC-WK0614', name: 'นายธีร์ธวัช ภูมิกอง (ฟลุ๊ค)', posName: 'ช่างระบบงานไฟฟ้า', role: 'USER' },

      { code: 'MC-EN0513', name: 'นางสาวณิชาภัทร วาจาดี (เอิร์น)', posName: 'เจ้าหน้าที่วิศวกรรมซ่อมบำรุง', role: 'USER' },
      { code: 'MC-WK0555', name: 'นายวีรศักดิ์ เหล่าลาพระ (เพียว)', posName: 'ช่างซ่อมบำรุง', role: 'USER' },
      { code: 'MC-WK0639', name: 'นายดนุพร ศุภรมย์ (แม็กซ์)', posName: 'ช่างซ่อมบำรุง', role: 'USER' },

      { code: 'MC-PP0291', name: 'นางสาวรุ่งฟ้า มงคลเคหา (วิว)', posName: 'หัวหน้าแผนกจัดซื้อและสโตร์', role: 'USER' },
      { code: 'MC-PP0553', name: 'นางสาวทินรัตน์ ผลเพิ่ม (เจี๊ยบ)', posName: 'เจ้าหน้าที่จัดซื้อ', role: 'USER' },
      { code: 'MC-AC0299', name: 'นางสาววัชราภรณ์ ภานุรักษ์ (ยุ)', posName: 'หัวหน้าแผนกบัญชีและการเงิน', role: 'USER' },
      { code: 'MC-AC0391', name: 'นางสาวประพิณ เรืองแจ่ม (นุช)', posName: 'เจ้าหน้าที่บัญชีและการเงิน', role: 'USER' },

      { code: 'MC-HR0527', name: 'นายรชต งามตระหง่าน (ป็อป)', posName: 'ผจก.ฝ่ายทรัพยากรบุคคลและธุรการ', role: 'USER' },
      { code: 'MC-HR0608', name: 'นางสาวเบญจวรรณ เอนอ่อน (โบว์)', posName: 'เจ้าหน้าที่ทรัพยากรบุคคลและธุรการ', role: 'USER' },
      { code: 'MC-WK0622', name: 'นางสาววรรณิภา สินไพร (กระนุ้งกระนิ้ง)', posName: 'เจ้าหน้าที่ฝ่ายทรัพยากรมนุษย์', role: 'USER' },
      ...
      { code: 'MC-EN0546', name: 'นายภาคภูมิ ชัยรัมย์ (ภาค)', posName: 'วิศวกรไฟฟ้า', role: 'USER' },
      { code: 'MC-EN0547', name: 'ว่าที่รต. อุดมศักดิ์ อรัญโสตร (เอก)', posName: 'วิศวกรไฟฟ้า', role: 'USER' },

      { code: 'MC-EN0240', name: 'นายทรงวิทย์ ขุนจบเมือง (วิทย์)', posName: 'ผจก.ฝ่ายวิศวกรรม', role: 'USER' },
      { code: 'MC-EN0472', name: 'นายอัจฉริยะ นวลล่อง (อัจ)', posName: 'วิศวกรการตลาด', role: 'USER' },
      { code: 'MC-SM0610', name: 'นายบันลือโลก วงทะนี (อ๋า)', posName: 'วิศวกรขายและการตลาด', role: 'USER' },
      { code: 'MC-WK0635', name: 'นายศิรศักดิ์ เผือกสงค์ (ไนซ์)', posName: 'เจ้าหน้าที่เขียนแบบ', role: 'USER' },
      { code: 'MC-MK0054', name: 'นายกฤฐิพงษ์ ศรีศิริ (ไก่)', posName: 'ผจก.ฝ่ายวิศวกรรมการขายและการตลาด', role: 'USER' },
      { code: 'MC-WK0535', name: 'นางสาวศิวรักษ์ อินทรแหยม (ป๊อป)', posName: 'ผู้ช่วยวิศวกรการขายและการตลาด', role: 'USER' },
      ...
      { code: 'MC-WK0621', name: 'นายสามารถ แสนภูมิ', posName: 'เจ้าหน้าที่ขนส่ง', role: 'USER' },
