...
class _AddUserPageState extends State<AddUserPage> {
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text('ยืนยันการพนักงาน', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color(0xFF003E75))),
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          globalEmployees.add(Employee(
                            ...
                            department: selectedDepartment == 'ไอที (IT)' ? 'IT' : selectedDepartment!,
                          ));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Colors.transparent, // 🟢 ทำให้ Scaffold โปร่งใสทะลุไปเห็นหน้าหลัง
      body: Stack(
        children: [
          // 🌫️ 1. ตัวทำพื้นหลังเบลอ
          Positioned.fill(
            child: BackdropFilter(
              filter: ImageFilter.blur(sigmaX: 6.0, sigmaY: 6.0), // ปรับความเบลอตรงนี้ (ยิ่งมากยิ่งเบลอ)
              child: GestureDetector(
                onTap: () => Navigator.pop(context), // กดพื้นที่ว่างเพื่อปิดหน้าต่างได้
                child: Container(
                  color: Colors.white.withOpacity(0.3), // ฟิล์มสีขาวจางๆ คลุมทับ
                ),
              ),
            ),
          ),
            ...
            child: SingleChildScrollView(
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    // หัวข้อ
                    const Text('เพิ่มพนักงานใหม่', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: Color(0xFF1B2B48))),
                    const SizedBox(height: 24),
