...
Future<void> _fetchVehicles() async {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text(
          'จองรถบริษัท', 
          style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold, fontFamily: 'Kanit'),
        ),
        centerTitle: true,
      ),
      body: Column(
        children: [
          ...
          Expanded(
            child: isLoading 
              ? const Center(child: CircularProgressIndicator(color: Color(0xFF004381)))
              : ValueListenableBuilder<List<VehicleModel>>(
                  valueListenable: globalVehicles,
                  builder: (context, vehicles, child) {
                    final activeVehicles = vehicles.where((v) => !v.isDeleted).toList();
                    ...
                    if (activeVehicles.isEmpty) {
                      return Column(
                        ...
                        children: [
                          ...
                          Text('ไม่มีรถยนต์ในระบบ', style: TextStyle(color: Colors.grey.shade500, fontSize: 16, fontFamily: 'Kanit')),
                        ],
                      );
                    }
  ...
  Widget _buildStepItem({required String step, required String title, required bool isActive}) {
    return Column(
      mainAxisSize: MainAxisSize.min,
      children: [
        Container(
          width: 70, height: 36, 
          decoration: BoxDecoration(color: isActive ? const Color(0xFF009CB4) : const Color(0xFFE6EDF5), shape: BoxShape.circle), 
        ...
        Text(title, style: const TextStyle(color: Color(0xFF003865), fontSize: 12, fontWeight: FontWeight.bold, fontFamily: 'Kanit')),
      ],
    );
  }
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  ...
                  style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Color(0xFF003E75), fontFamily: 'Kanit'),
                  textAlign: TextAlign.center,
                ),
  ...
  Widget _buildVehicleCard(VehicleModel vehicle) {
    bool isAvailable = (vehicle.status.toUpperCase() == 'AVAILABLE' || vehicle.status == 'ว่างพร้อมใช้งาน');
                ...
                children: [
                  Row(
                    ...
                    children: [
                      Expanded(
                        child: Text(
                          vehicle.vehicleName.isNotEmpty ? vehicle.vehicleName : 'ไม่ระบุรุ่น', 
                          style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color(0xFF1E3A8A), fontFamily: 'Kanit'),
                          maxLines: 1,
                      ...
                      Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(displayStatus, style: TextStyle(color: statusColor, fontSize: 12, fontWeight: FontWeight.bold, fontFamily: 'Kanit')),
                          ],
                        ),
                      ),
                    ],
                  ...
                  Text(
                    vehicle.plateNumber.isNotEmpty ? vehicle.plateNumber : 'ไม่ระบุทะเบียน', 
                    style: const TextStyle(fontSize: 14, color: Color(0xFF6B7280), fontFamily: 'Kanit'),
                  ),
                  const SizedBox(height: 16),
                  ...
                  Row(
                    children: [
                      ...
                      Text(
                        ...
                        style: const TextStyle(fontSize: 12, color: Color(0xFF1D4ED8), fontWeight: FontWeight.bold, fontFamily: 'Kanit'),
                      ),
                    ],
                  ),
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      child: const Text('เลือกรถคันนี้', style: TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.bold, fontFamily: 'Kanit')),
                    ),
                  ),
                ],
              ),
