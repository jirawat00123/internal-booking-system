...
class _AdminEditRoomScreenState extends State<AdminEditRoomScreen> {
  ...
  void initState() {
    ...
    floorNumber =
        int.tryParse(widget.room.floor) ??
        1; // ป้องกันบั๊กกรณีแปลง String เป็น int ไม่ได้
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            ...
                            globalMeetingRooms[widget.index] = MeetingRoom(
                              ...
                              capacity: capacity,
                              imagePath:
                                  _imageFile?.path ?? widget.room.imagePath,
                              status: selectedStatus,
                            );

                            Navigator.pop(dialogContext); // ปิด Dialog ก่อน

                            // ป้องกันบั๊กแอปเด้ง (Context Exception) หากหน้าจอถูกปิดไปแล้ว
              ...
              decoration: BoxDecoration(
                ...
                image: _imageFile != null
                    ...
                    : (widget.room.imagePath != null &&
                          ...
                          ? DecorationImage(
                              image: FileImage(File(widget.room.imagePath!)),
                              fit: BoxFit.cover,
                            )
                          : null),
              ),
