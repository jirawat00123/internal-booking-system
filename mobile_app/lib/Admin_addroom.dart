...
import 'Room_model.dart'; // นำเข้าเพื่อเรียกใช้งานคลาส MeetingRoom อย่างถูกต้อง
...
class AddMeetingRoomScreen extends StatefulWidget {
  const AddMeetingRoomScreen({super.key});

  @override
  // 💡 แก้ไข: เปลี่ยนชนิดข้อมูลส่งกลับเป็น State<AddMeetingRoomScreen> เพื่อแก้เส้นเตือนสีฟ้า
  State<AddMeetingRoomScreen> createState() => _AddMeetingRoomScreenState();
}
                    ...
                    Expanded(
                      child: SizedBox(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            // ==========================================
                            // 💡 สั่งเพิ่มข้อมูลเข้าสู่หน้าหน้าห้องประชุมส่วนกลางก่อนสลับหน้า
                            // ==========================================
                            globalMeetingRooms.add(
                              MeetingRoom(
                                ...
                                capacity: capacity,
                                imagePath:
                                    _imageFile?.path ?? '', // ป้องกันค่า null
                              ),
                            );

                            Navigator.pop(
                              dialogContext,
                            ); // 1. เคลียร์ปิดตัว Popup นี้ออกก่อน

                            debugPrint(
                              'บันทึกข้อมูลเข้าสู่ globalMeetingRooms เรียบร้อยแล้ว',
                            );
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color: isSelected
                  ? const Color(0xFF00529B).withValues(alpha: 0.5)
